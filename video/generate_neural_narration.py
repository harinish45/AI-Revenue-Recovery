    ...
    for i, (seconds, text) in enumerate(SEGMENTS, 1):
        ...
        subprocess.run(
            [
                ...
                "lavfi",
                "-i",
                f"flite=textfile=voice-{i}.txt:voice={VOICE}",
                "-af",
                f"apad,atrim=duration={seconds}",
                "-ar",
                "48000",
                "-ac",
                "2",
